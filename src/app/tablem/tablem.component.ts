...
const ELEMENT_DATA: PeriodicElement[] = [
  { position: 1, name: 'Hydrogen', weight: 1.0079, symbol: 'gen' },
  { position: 2, name: 'Helium', weight: 4.0026, symbol: 'nongen' },
  { position: 3, name: 'Lithium', weight: 6.941, symbol: 'sustitution' },
  { position: 4, name: 'Beryllium', weight: 9.0122, symbol: 'pending' },
